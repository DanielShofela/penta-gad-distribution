...
import { ShoppingCart, ArrowLeft, Plus, Minus, CheckCircle, Package, ShieldCheck, Truck, DollarSign, Bookmark, Share2, Star, ChevronRight, User, Send, Edit2, Trash2 } from 'lucide-react';
...
const ItemDetail = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-0 pb-6 sm:py-12">
      ...
      {isAdmin && (
        <div className="bg-blue-50 border border-blue-100 p-4 rounded-2xl mb-8 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-black text-blue-900 uppercase tracking-widest">Contrôle Administrateur</p>
              <p className="text-[10px] text-blue-600 font-bold uppercase tracking-wider">Outils de gestion en direct</p>
            </div>
          </div>
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <button 
              onClick={() => navigate(`/admin/items?edit=${id}`)}
              className="flex-grow sm:flex-grow-0 flex items-center justify-center gap-2 bg-white text-blue-900 px-5 py-2.5 rounded-xl font-bold text-xs border border-blue-200 hover:bg-blue-50 hover:border-blue-300 transition-all shadow-sm"
            >
              <Edit2 size={16} /> Modifier l'article
            </button>
            <button 
              onClick={handleDeleteItem}
              className="flex-grow sm:flex-grow-0 flex items-center justify-center gap-2 bg-red-50 text-red-600 px-5 py-2.5 rounded-xl font-bold text-xs border border-red-100 hover:bg-red-100 transition-all shadow-sm"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
        ...
        <div className="flex flex-col">
          ...
          {!isAdmin && (
            <div className="mt-auto space-y-4 pt-8 border-t border-gray-100 lg:border-none lg:pt-0">
              <div className="flex flex-col sm:flex-row items-stretch gap-4">
                <div className="flex items-center justify-between border border-gray-200 rounded-xl p-1 bg-white min-w-[140px]">
                  <button 
                    onClick={() => setQuantity(Math.max(1, quantity - 1))}
                    className="p-3 hover:bg-gray-50 rounded-lg transition-colors text-blue-900"
                  >
                    <Minus size={20} />
                  </button>
                  <span className="text-lg font-black text-blue-900">{quantity}</span>
                  <button 
                ...
                <button 
                  ...
                  className="flex-grow bg-blue-900 text-white py-4 rounded-xl font-bold hover:bg-blue-800 transition-all flex items-center justify-center gap-3 shadow-xl shadow-blue-900/20 disabled:bg-gray-300 disabled:shadow-none"
                >
              ...
              <div className="grid grid-cols-2 gap-4">
                <a 
                  href={`https://wa.me/2250102030405?text=Bonjour, je suis intéressé par l'article : ${item.name} (${window.location.href})`}
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center justify-center gap-2 py-3 px-4 rounded-xl border-2 border-green-500 text-green-600 font-black text-xs uppercase tracking-widest hover:bg-green-50 transition-all"
                >
                ...
                <button 
                  ...
                  className="flex items-center justify-center gap-2 py-3 px-4 rounded-xl border-2 border-blue-100 text-blue-900 font-black text-xs uppercase tracking-widest hover:bg-blue-50 transition-all"
                >
                  <Share2 size={18} />
                  Partager
                </button>
